...
export function generateShip() {
  ...
  generateDeckplan(hullType, fittings)
  return {
    name,
    purpose,
    hullType,
...
export function generateHullType(money) {
  const options = [
    ...
    { value: 'Patrol Boat',    cost: 2500000,  hullClass: 'Frigate', power: 15, mass: 10,  hard: 4,  minCrew: 5,   maxCrew: 20,   maxRooms: 5 },
    { value: 'Corvette',       cost: 4000000,  hullClass: 'Frigate', power: 15, mass: 15,  hard: 6,  minCrew: 10,  maxCrew: 40,   maxRooms: 6 },
    { value: 'Heavy Frigate',  cost: 7000000,  hullClass: 'Frigate', power: 25, mass: 20,  hard: 8,  minCrew: 30,  maxCrew: 120,  maxRooms: 7 },
    { value: 'Bulk Freighter', cost: 5000000,  hullClass: 'Cruiser', power: 15, mass: 25,  hard: 2,  minCrew: 10,  maxCrew: 40,   maxRooms: 10 },
    { value: 'Fleet Cruiser',  cost: 10000000, hullClass: 'Cruiser', power: 50, mass: 30,  hard: 10, minCrew: 50,  maxCrew: 200,  maxRooms: 11 },
    { value: 'Battleship',     cost: 50000000, hullClass: 'Capital', power: 75, mass: 50,  hard: 15, minCrew: 200, maxCrew: 1000, maxRooms: 13 },
...
export function generateFitting(resources, hullClass, purpose, fittings) {
  const options = [
    { value: 'Advanced lab',               weight: 10,  group: 'research',    cost: 10000,   costMultiplier: true,  power: 1, powerMultiplier: true,  mass: 2,   massMultiplier: false, room: true,  hullClass: 'Frigate' },
    { value: 'Advanced nav computer',      weight: 10,  group: 'travel',      cost: 10000,   costMultiplier: true,  power: 1, powerMultiplier: true,  mass: 0,   massMultiplier: false, room: false, hullClass: 'Frigate' },
    { value: 'Amphibious operation',       weight: 10,  group: 'stealth',     cost: 25000,   costMultiplier: true,  power: 1, powerMultiplier: false, mass: 1,   massMultiplier: true,  room: false, hullClass: 'Frigate', maxHullClass: 'Frigate' },
    { value: 'Armory',                     weight: 10,  group: 'aggression',  cost: 10000,   costMultiplier: true,  power: 0, powerMultiplier: false, mass: 0,   massMultiplier: false, room: true,  hullClass: 'Frigate' },
    { value: 'Atmospheric configuration',  weight: 50,  group: 'general',     cost: 5000,    costMultiplier: true,  power: 0, powerMultiplier: false, mass: 1,   massMultiplier: true,  room: false, hullClass: 'Fighter', maxHullClass: 'Frigate' },
    { value: 'Auto-targeting system',      weight: 10,  group: 'aggression',  cost: 50000,   costMultiplier: false, power: 1, powerMultiplier: false, mass: 0,   massMultiplier: false, room: false, hullClass: 'Fighter' },
    { value: 'Automation support',         weight: 10,  group: 'general',     cost: 10000,   costMultiplier: true,  power: 2, powerMultiplier: true , mass: 1,   massMultiplier: false, room: false, hullClass: 'Fighter' },
    { value: 'Boarding tubes',             weight: 10,  group: 'aggression',  cost: 5000,    costMultiplier: true,  power: 0, powerMultiplier: false, mass: 1,   massMultiplier: false, room: false, hullClass: 'Frigate' },
    { value: 'Cargo lighter',              weight: 10,  group: 'trade',       cost: 25000,   costMultiplier: false, power: 0, powerMultiplier: false, mass: 2,   massMultiplier: false, room: true,  hullClass: 'Frigate' },
    { value: 'Cargo space',                weight: 10,  group: 'trade',       cost: 0,       costMultiplier: false, power: 0, powerMultiplier: false, mass: 1,   massMultiplier: false, room: true,  hullClass: 'Fighter', multiple: true },
    { value: 'Cold sleep pods',            weight: 10,  group: 'general',     cost: 5000,    costMultiplier: true,  power: 1, powerMultiplier: false, mass: 1,   massMultiplier: false, room: true,  hullClass: 'Frigate', multiple: true  },
    { value: 'Colony core',                weight: 10,  group: 'colonial',    cost: 100000,  costMultiplier: true,  power: 4, powerMultiplier: false, mass: 2,   massMultiplier: true,  room: true,  hullClass: 'Frigate' },
    { value: 'Drill course regulator',     weight: 4,   group: 'travel',      cost: 25000,   costMultiplier: true,  power: 1, powerMultiplier: true,  mass: 1,   massMultiplier: false, room: false, hullClass: 'Frigate' },
    { value: 'Drive-2 upgrade',            weight: 10,  group: 'drive',       cost: 10000,   costMultiplier: true,  power: 1, powerMultiplier: true,  mass: 0,   massMultiplier: true,  room: false, hullClass: 'Frigate' },
    { value: 'Drive-3 upgrade',            weight: 8,   group: 'drive',       cost: 20000,   costMultiplier: true,  power: 2, powerMultiplier: true,  mass: 0,   massMultiplier: true,  room: false, hullClass: 'Frigate' },
    { value: 'Drive-4 upgrade',            weight: 3,   group: 'drive',       cost: 40000,   costMultiplier: true,  power: 2, powerMultiplier: true,  mass: 0,   massMultiplier: true,  room: false, hullClass: 'Frigate' },
    { value: 'Drive-5 upgrade',            weight: 2,   group: 'drive',       cost: 100000,  costMultiplier: true,  power: 3, powerMultiplier: true,  mass: 0,   massMultiplier: true,  room: false, hullClass: 'Frigate' },
    { value: 'Drive-6 upgrade',            weight: 1,   group: 'drive',       cost: 500000,  costMultiplier: true,  power: 3, powerMultiplier: true,  mass: 0,   massMultiplier: true,  room: false, hullClass: 'Cruiser' },
    { value: 'Drop pod',                   weight: 10,  group: 'aggression',  cost: 300000,  costMultiplier: false, power: 0, powerMultiplier: false, mass: 2,   massMultiplier: false, room: true,  hullClass: 'Frigate', multiple: true },
    { value: 'Emissions dampers',          weight: 10,  group: 'stealth',     cost: 25000,   costMultiplier: true,  power: 1, powerMultiplier: true,  mass: 1,   massMultiplier: true,  room: false, hullClass: 'Cruiser' },
    { value: 'Exodus bay',                 weight: 10,  group: 'colonial',    cost: 50000,   costMultiplier: true,  power: 1, powerMultiplier: true,  mass: 2,   massMultiplier: false, room: true,  hullClass: 'Frigate', multiple: true },
    { value: 'Extended life support',      weight: 6,   group: 'survival',    cost: 5000,    costMultiplier: true,  power: 1, powerMultiplier: true,  mass: 1,   massMultiplier: true,  room: false, hullClass: 'Fighter', multiple: true },
    { value: 'Extended medbay',            weight: 10,  group: 'survival',    cost: 5000,    costMultiplier: true,  power: 1, powerMultiplier: false, mass: 1,   massMultiplier: false, room: true,  hullClass: 'Frigate' },
    { value: 'Extended stores',            weight: 6,   group: 'survival',    cost: 2500,    costMultiplier: true,  power: 0, powerMultiplier: false, mass: 1,   massMultiplier: true,  room: true,  hullClass: 'Fighter', multiple: true  },
    { value: 'Fuel bunkers',               weight: 6,   group: 'travel',      cost: 2500,    costMultiplier: true,  power: 0, powerMultiplier: false, mass: 1,   massMultiplier: false, room: false,  hullClass: 'Fighter', multiple: true  },
    { value: 'Fuel scoops',                weight: 10,  group: 'survival',    cost: 5000,    costMultiplier: true,  power: 2, powerMultiplier: false, mass: 1,   massMultiplier: true,  room: false, hullClass: 'Frigate' },
    { value: 'Hydroponic production',      weight: 10,  group: 'industry',    cost: 10000,   costMultiplier: true,  power: 1, powerMultiplier: true,  mass: 2,   massMultiplier: true,  room: true,  hullClass: 'Cruiser', multiple: true },
    { value: 'Lifeboats',                  weight: 10,  group: 'survival',    cost: 2500,    costMultiplier: true,  power: 0, powerMultiplier: false, mass: 1,   massMultiplier: false, room: true,  hullClass: 'Frigate' },
    { value: 'Luxury cabins',              weight: 10,  group: 'luxury',      cost: 10000,   costMultiplier: true,  power: 1, powerMultiplier: false, mass: 1,   massMultiplier: true,  room: true,  hullClass: 'Frigate', multiple: true },
    { value: 'Mobile extractor',           weight: 10,  group: 'industry',    cost: 50000,   costMultiplier: false, power: 2, powerMultiplier: false, mass: 1,   massMultiplier: false, room: true,  hullClass: 'Frigate' },
    { value: 'Mobile factory',             weight: 10,  group: 'industry',    cost: 50000,   costMultiplier: true,  power: 3, powerMultiplier: false, mass: 2,   massMultiplier: true,  room: true,  hullClass: 'Frigate' },
    { value: 'Precognitive nav chamber',   weight: 10,  group: 'travel',      cost: 100000,  costMultiplier: true,  power: 1, powerMultiplier: false, mass: 0,   massMultiplier: false, room: false, hullClass: 'Frigate' },
  //{ value: 'Psionic anchorpoint',        weight: 10,  group: '',            cost: 10000,   costMultiplier: false, power: 0, powerMultiplier: false, mass: 0,   massMultiplier: false, room: false, hullClass: 'Frigate' },
    { value: 'Sensor mask',                weight: 10,  group: 'stealth',     cost: 10000,   costMultiplier: true,  power: 1, powerMultiplier: true,  mass: 0,   massMultiplier: false, room: false, hullClass: 'Frigate' },
    { value: 'Ship bay/fighter',           weight: 10,  group: 'aggression',  cost: 200000,  costMultiplier: false, power: 0, powerMultiplier: false, mass: 2,   massMultiplier: false, room: true,  hullClass: 'Cruiser', multiple: true },
    { value: 'Ship bay/frigate',           weight: 10,  group: 'aggression',  cost: 1000000, costMultiplier: false, power: 1, powerMultiplier: false, mass: 4,   massMultiplier: false, room: true,  hullClass: 'Capital', multiple: true },
    { value: 'Ship’s locker',              weight: 10,  group: 'general',     cost: 2000,    costMultiplier: true,  power: 0, powerMultiplier: false, mass: 0,   massMultiplier: false, room: true,  hullClass: 'Frigate' },
    { value: 'Shiptender mount',           weight: 10,  group: 'industry',    cost: 25000,   costMultiplier: true,  power: 1, powerMultiplier: false, mass: 1,   massMultiplier: false, room: false, hullClass: 'Frigate' },
    { value: 'Smuggler’s hold',            weight: 10,  group: 'stealth',     cost: 2500,    costMultiplier: true,  power: 0, powerMultiplier: false, mass: 1,   massMultiplier: false, room: false, hullClass: 'Fighter', multiple: true },
    { value: 'Survey sensor array',        weight: 10,  group: 'exploration', cost: 5000,    costMultiplier: true,  power: 2, powerMultiplier: false, mass: 1,   massMultiplier: false, room: false, hullClass: 'Frigate' },
    { value: 'System drive',               weight: 2,  group: 'bad-drive',    cost: 0,       costMultiplier: false, power: 1, powerMultiplier: true,  mass: 2,   massMultiplier: true,  room: false, hullClass: 'Fighter' },
  //{ value: 'Teleportation pads',         weight: 10,  group: '',            cost: 10000,   costMultiplier: false, power: 0, powerMultiplier: false, mass: 0,   massMultiplier: false, room: false, hullClass: 'Frigate' },
    { value: 'Tractor beams',              weight: 10,  group: 'general',     cost: 10000,   costMultiplier: true,  power: 2, powerMultiplier: false, mass: 1,   massMultiplier: false, room: false, hullClass: 'Frigate' },
    { value: 'Vehicle transport fittings', weight: 10,  group: 'aggression',  cost: 10000,   costMultiplier: true,  power: 0, powerMultiplier: false, mass: 1,   massMultiplier: true,  room: false, hullClass: 'Frigate' },
    { value: 'Workshop',                   weight: 10,  group: 'industry',    cost: 500,     costMultiplier: true,  power: 1, powerMultiplier: false, mass: 0.5, massMultiplier: true,  room: true,  hullClass: 'Frigate' },
  ]
